(() => {
  ...
  function bindEvents() {
    ...
    [els.taxRate, els.rounding, els.tireAddition, els.defaultRate, els.wheelMarkup, els.wheelPricingMode, els.wheelImageDisplay].forEach(input => input.addEventListener("input", () => {
